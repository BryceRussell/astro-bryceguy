...
export const inline = {
    ...
    toggle: {
        style: 'position:relative;padding:.2rem .5rem .25rem .5rem;border-radius:5px;border: 2px solid #E5E7EB;user-select:none;white-space:nowrap;line-height:1;'
    },
    content: {
...
export const tailwindHamburger = {
    ...
    toggle: {
        class: "relative flex items-center gap-1 px-2 pt-0.5 pb-1 rounded-md border-2 select-none leading-none whitespace-nowrap text-lg marker:content-none before:leading-none before:text-3xl before:content-['☰'] focus-visible:outline-none focus:border-sky-600 group-open:text-sky-600"
    },
    content: {
