...
export const inline = {
    ...
    content: {
        style: "z-index:10;position:absolute;margin-top:.25rem;display:flex;flex-direction:column;gap:3px;background-color:#fff;border-radius:5px;border:2px solid #E5E7EB;"
    },
    options: {
...
export const tailwind = {
    container: {
        class: 'z-10 group flex items-center',
    },
    toggle: {
    ...
    content: {
        class: 'absolute flex flex-col justify-start h-auto mt-1 bg-white rounded-md border-2 focus-within:border-sky-600 first:rounded-t-md last:rounded-b-md [&>*]:px-2 [&>*]:py-0.5 [&>*]:text-left focus-within:[&>*]:outline-none hover:[&>*]:bg-neutral-100 focus:[&>*]:bg-neutral-100',
    },
    options: {}
}

export const tailwindTextbox= {
    container: {
    ...
    content: {
        class: 'overflow-auto z-10 flex flex-col justify-start h-auto mt-1 bg-white rounded-md border-2 focus-within:border-sky-600 [&>*]:px-2 [&>*]:py-0.5 [&>*]:text-left focus-within:[&>*]:outline-none hover:[&>*]:bg-neutral-100 focus:[&>*]:bg-neutral-100',
    },
    options: {}
}
